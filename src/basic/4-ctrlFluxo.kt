...
// o mais próximo de ternário - if e else é uma expressão, por isso consigo atribuir diretamente ele
...
// Operador Elvis ?:
    ...
    // string "Operador Elvis atribuído", senão recebe o próprio valor da variável test
